...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QW] = LAYOUT(
        ...
        KC_LSFT, SE_Z,    SE_X,    SE_C,    SE_V,    SE_B,    SE_QUOT, KC_NUBS, SE_N,    SE_M,    SE_COMM, SE_DOT,  SE_SLSH, KC_ENT,
                                   KC_LALT, KC_LCTL, KC_SPC,  MO(_FH), MO(_FH), KC_SPC,  KC_RGUI, KC_RALT
    ),
	/* 
	[_QW] = LAYOUT(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_MINS, KC_EQL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC, KC_RBRC, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_ARNG,
	...
	*/
    ...
    [_FH] = LAYOUT(
        ...
        _______, KC_PMNS, HOME_P4, HOME_P5, HOME_P6, KC_PDOT, KC_VOLD, KC_MNXT, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, KC_F14,
        TO(_BH), KC_P0,   KC_P1,   KC_P2,   KC_P3,   KC_PSLS, KC_MUTE, KC_MPLY, _______, _______, _______, _______, _______, TO(_BH),
