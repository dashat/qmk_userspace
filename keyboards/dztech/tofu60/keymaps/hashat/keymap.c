...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BH] = LAYOUT_60_iso_split_bs_rshift(
        ...
        KC_BSPC, HOME_A,  HOME_R,  HOME_S,  HOME_T,  SE_ODIA, SE_QUOT, SE_SCLN, SE_ADIA, HOME_N,  HOME_E,  HOME_I,  HOME_O,  KC_ENT,
        KC_LSFT, SE_Z,    SE_X,    SE_C,    SE_D,    SE_V,    SE_COMM, SE_DOT,  SE_B,    SE_H,    SE_M,    SE_K,    KC_RSFT, TT(_FH),
        KC_LGUI, KC_LALT,    KC_LCTL,                            KC_SPC,                          KC_RALT,  TT(_FL), KC_RGUI, KC_RCTL
    ), 
	...
	[_QW] = LAYOUT_60_iso_split_bs_rshift(
        ...
        KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, TT(_FH),
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, TT(_FL), TG(_QW), KC_RCTL
    ),
	...
	[_FH] = LAYOUT_60_iso_split_bs_rshift(
        ...
        _______, KC_PMNS, KC_P0,   KC_P1,   KC_P2,   KC_P3,   KC_PSLS, KC_MPLY, KC_VOLD, KC_VOLU, KC_MUTE, _______, _______, TO(_BH),
        _______, _______, _______,                              KC_PENT,                         _______,  TG(_BL), TG(_QW), _______
    ),
