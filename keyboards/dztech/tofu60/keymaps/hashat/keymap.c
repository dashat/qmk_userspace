...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_60_iso_split_bs_rshift(
        ...
        KC_LGUI, KC_LALT,    KC_LCTL,                            KC_SPC,                          OSM(MOD_RALT),  MO(3),    MO(1), KC_RCTL
    ),    
	...
	[2] = LAYOUT_60_iso_split_bs_rshift(
        ...
        _______, KC_P0,   KC_P1,   KC_P2,   KC_P3,   _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
