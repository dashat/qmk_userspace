...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT( KC_MPLY, KC_MNXT, DPI_CONFIG, MO(2), KC_BTN3, XXXXXXX ),
	[2] = LAYOUT( XXXXXXX, DF(3), QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX ),
	
	// Mirrored layout
	[3] = LAYOUT( KC_BTN2, DRAG_SCROLL, KC_BTN5, KC_BTN4, MO(4), KC_BTN1 ),
	[4] = LAYOUT( MO(5), DPI_CONFIG, KC_MNXT, KC_MPLY, XXXXXXX, KC_BTN3 ),
	[5] = LAYOUT( XXXXXXX, DF(0), QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX )
};
